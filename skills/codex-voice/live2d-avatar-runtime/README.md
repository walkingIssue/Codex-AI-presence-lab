...
- The `live2d-avatar-controls` skill is the agent-facing workflow wrapper.
- `codex-voice` stays model-agnostic and will receive only the negotiated generic avatar-state contract.
